...
SELECT 
    ...
    ib.original_status,
    ib.delay_reason,
    af.alt_flight_id AS rebook_flight_id,
    af.alt_flight_number AS rebook_flight_number,
    af.alt_departure AS rebook_departure,
    af.alt_arrival AS rebook_arrival,
    af.available_seats,
    af.aircraft_type_code AS rebook_aircraft,
    DATEDIFF('minute', ib.original_departure, af.alt_departure) AS minutes_after_original,
    ROW_NUMBER() OVER (
